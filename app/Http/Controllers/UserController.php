...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Users::where('id', $id)
        ->update(['nik' => $request->nik,'name' => $request->name, 'telepon' => $request->telepon, 'alamat' => $request->alamat, 'maps' => $request->maps, 'image' => $namafile]);    
        }else{
        Users::where('id', $id)
        ->update(['nik' => $request->nik,'name' => $request->name, 'telepon' => $request->telepon, 'alamat' => $request->alamat, 'maps' => $request->maps]);
        }
